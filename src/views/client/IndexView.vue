...
<script>
import Top from "@/section/client/Top.vue";
import Search from "@/section/client/Search.vue";
import NavBar from "@/section/client/NavBar.vue";
import Carousel from "@/section/client/Carousel.vue";
import Bottom from "@/section/client/Bottom.vue";
...
.category_header>div:first-child {
    border-left: 5px solid var(--color-main-black);
    padding-left: 10px;
}
...
.category_header>div:last-child>img {
    width: 16px;
    height: 16px;
}
